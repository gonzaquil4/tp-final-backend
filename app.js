...
app.get('/integrantes/:dni', (req, res) => {
    ...
    res.status(integrante ? 200 : 404).json(integrante || { error: 'El usuario no se encuentra en nuestros archivos' });
...
app.put('/integrantes/:email', (req, res) => {
    ...
    : res.status(404).json({ error: 'El usuario no se encuentra en nuestros archivos' });
